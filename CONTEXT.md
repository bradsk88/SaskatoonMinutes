...
- **Settled** — a Meeting is publishable once it has cached summaries, or seven days have passed. A meeting settles on its own, without waiting on a sibling that sat the same day. Nothing is published thin and filled in later: a reader who saw the thin version would never be shown the full one. The seven days are what stops a meeting with no video from waiting forever.
